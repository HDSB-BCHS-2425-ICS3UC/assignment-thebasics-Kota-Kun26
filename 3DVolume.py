...
length=float(input("Please enter the length of one edge of your cube:"))
...
height=float(input("Please enter the height of your cone:"))
radius=float(input("Please enter the radius of your cone:"))
...
height=float(input("Please enter the height of your cylinder:"))
